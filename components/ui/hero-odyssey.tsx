...
import geosense from "@/images/geosense.png";
...
export const HeroSection: React.FC = () => {
  ...
  return (
    <div className="relative w-full bg-black text-white overflow-visible">
      {/* Main container with space for content */}
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 min-h-screen pb-24">
        {/* Navigation */}
        <motion.div
        ...
        >
          ...
          <div className="flex items-center space-x-4">
            <button className="hidden md:block px-4 py-2 text-sm hover:text-gray-300 transition-colors">Work With Us</button>
            <button className="px-4 py-2 bg-gray-800/80 backdrop-blur-sm rounded-full text-sm hover:bg-gray-700/80 transition-colors">Get in Touch</button>
            {/* Mobile menu button */}
            <button
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            <div className="flex flex-col items-center justify-center h-full space-y-6 text-lg">
              ...
              <button className="px-6 py-3 bg-gray-800/80 backdrop-blur-sm rounded-full">Get in Touch</button>
            </div>
          </motion.div>
        )}
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="relative z-30 flex flex-col items-center text-center max-w-3xl mx-auto mt-8 md:mt-12 gap-4"
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center space-x-2 px-4 py-2 bg-white/5 hover:bg-white/10 backdrop-blur-sm rounded-full text-sm transition-all duration-300 group"
          >
          ...
          >
            Advanced drone systems, custom flight controllers, and unmanned aerial platforms redefining the standards of aerial innovation. From research labs to real-world deployment, we power the next generation of autonomous flight.
          </motion.p>
      ...
      >
        ...
        {/* Glowing circle */}
        <div className="absolute top-[55%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[960px] h-[960px] rounded-full bg-gradient-to-b from-blue-500/20 to-purple-600/10 blur-3xl"></div>
        ...
        {/* Geosense image with reflection */}
        <div className="z-10 absolute top-[50%] left-1/2 -translate-x-1/2 w-[360px] h-[360px] md:w-[480px] md:h-[480px] lg:w-[560px] lg:h-[560px]">
          <div className="relative w-full h-full">
            <Image
              ...
              fill
              priority
              className="object-contain drop-shadow-[0_0_40px_rgba(80,160,255,0.35)]"
            />
            <div className="absolute inset-0 rounded-full bg-gradient-to-b from-white/10 via-white/0 to-white/0 mix-blend-screen"></div>
            <div className="absolute left-1/2 top-full -translate-x-1/2 w-[80%] h-[35%] opacity-40 blur-2xl">
              <Image
                src={geosense}
                alt="Geosense reflection"
                fill
